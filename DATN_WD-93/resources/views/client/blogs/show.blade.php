...
@section('content')
    ...
    <style>
        ...
        .quill-content img {
            max-width: 100%;
            /* Giới hạn chiều rộng ảnh trong khung */
            height: auto;
            /* Duy trì tỉ lệ gốc */
            display: block;
            /* Đảm bảo ảnh căn chỉnh đúng */
        }
        ...
        .quill-content {
            ...
            /* Xử lý text dài không bị vỡ khung */
        }
    </style>
    ...
    <div class="container my-5">
        ...
        <h1 class="text-start mb-4">{{ $showBlog->title }}</h1>
        <div class="row">
            <div class="col-md-8">

                <div class="d-flex justify-content-end">
                    <p>Ngày đăng: {{ $showBlog->created_at }}</p>
                </div>
                <h4 class="text-start mb-4">{{ $showBlog->short_content }}</h4>
                <img src="{{ Storage::url($showBlog->image) }}" class="img-fluid" alt="">
                <div class="quill-content">
                    <p style="word-wrap: break-word;">{!! $showBlog->content !!}</p>
                </div>
            </div>
            <div class="col-md-4">
