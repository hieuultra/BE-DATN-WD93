...
<body>
        ...
        <div id="myAppointments" style="display: block;">
            ...
            <div class="card mb-3 appointment-card" data-id="{{ $appointment->id }}" data-date="{{ \Carbon\Carbon::parse($time->date)->format('Y-m-d') }}">
                <div class="card-body">
                    ...
                    <p><strong>Địa điểm:</strong> Phòng khám {{ $appointment->doctor->user->address }}</p>
                    <p class="price">Giá: {{ number_format($appointment->doctor->price, 0, ',', '.') }} vnd</p>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.doctors.reviewDortor') }}" method="POST">
                            @csrf
    ...
    <script>
        $(document).on('click', '.edit-review-btn', function(e) {
            ...
            $.ajax({
                url: '/admin/doctors/reviews/' + reviewId + '/edit',
                type: 'GET',
        ...
        $('#editReviewForm').submit(function(e) {
            ...
            $.ajax({
                url: '/admin/doctors/reviews/' + reviewId,
                type: 'PUT',
                data: formData,
                headers: {
        ...
        $(document).ready(function() {
            $('.review-btn').click(function(e) {
                ...
                $.ajax({
                    url: '/admin/doctors/appointments/get-review-data', 
                    type: 'POST',
                    data: {
