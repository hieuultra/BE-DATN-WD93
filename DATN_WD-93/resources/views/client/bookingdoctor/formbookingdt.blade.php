...
<body>
    ...
    <div class="container">
        ...
        <form id="form1" action="{{route('bookAnAppointment')}}" method="POST" style="display: none;">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="patientName" name="name" placeholder="Họ tên bệnh nhân (bắt buộc)" type="text" />
            ...
            <div class="mb-3">
                ...
                <div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" id="selfMale" name="gender" type="radio"
                            value="nam" />
                        <label class="form-check-label" for="selfMale">
                            Nam
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" id="selfFemale" name="gender" type="radio" value="nữ" />
                        <label class="form-check-label" for="selfFemale">
                            Nữ
                        </label>
                    </div>
                </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="phone" name="phone" placeholder="Số điện thoại liên hệ (bắt buộc)" type="text" />
            </div>
            <div class="mb-3">
                <label class="form-label" for="email">
                    Địa chỉ email
                </label>
                <input class="form-control" id="email" name="email" placeholder="Địa chỉ email" type="email" />
            </div>
            <div class="mb-3">
                <label class="form-label" for="birthYear">
                    Năm sinh (bắt buộc)
                </label>
                <input class="form-control" id="birthYear" name="year_of_birth" placeholder="Năm sinh (bắt buộc)" type="text" />
            </div>
            <div class="mb-3">
                <label class="form-label" for="province1">
                    -- Chọn Tỉnh/Thành --
                </label>
                <select class="form-select" id="province1" name="tinh_thanh" onchange="updateDistricts('province1', 'district1')">
                    <option selected="">
                        -- Chọn Tỉnh/Thành --
                    </option>
            ...
            <div class="mb-3">
                <label class="form-label" for="district1">
                    -- Chọn Quận/Huyện --
                </label>
                <select class="form-select" name="quan_huyen" id="district1">
                    <option selected="">
                        -- Chọn Quận/Huyện --
                    </option>
                </select>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" name="dia_chi" id="address" placeholder="Địa chỉ" type="text" />
            </div>
            <div class="mb-3">
                <label class="form-label" for="reason">
                    Lý do khám
                </label>
                <textarea class="form-control" name="notes" id="reason" placeholder="Lý do khám" rows="3"></textarea>
            </div>
            <div class="mb-3">
                <label class="form-label">
            ...
            <div class="mb-3">
                ...
                <p class="form-text">{{ number_format($doctor->price, 0, ',', '.') }} VND</p>
        ...
        <!-- Form đặt cho mình -->
        @if(Auth::check())
        <form id="form2" action="{{route('bookAnAppointment')}}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                <label class="form-label" for="selfBirthYear">
                    Năm sinh (bắt buộc)
                </label>
                <strong>@if ($errors->has('year_of_birth'))
                    <div style="color: red;">{{ $errors->first('year_of_birth') }}</div>
                    @endif
                </strong><br>
                <input class="form-control" id="selfBirthYear" name="year_of_birth" placeholder="Năm sinh (bắt buộc)" type="text" />
            </div>
            <div class="mb-3">
                <label class="form-label" for="province2">
                    -- Chọn Tỉnh/Thành --
                </label>
                <strong>@if ($errors->has('tinh_thanh'))
                    <div style="color: red;">{{ $errors->first('tinh_thanh') }}</div>
                    @endif
                </strong><br>
                <select class="form-select" name="tinh_thanh" id="province2" onchange="updateDistricts('province2', 'district2')">
                    <option selected="">
                        -- Chọn Tỉnh/Thành --
                    </option>
                    <option value="hanoi">Hà Nội</option>
            ...
            <div class="mb-3">
                <label class="form-label" for="district2">
                    -- Chọn Quận/Huyện --
                </label>
                <strong>@if ($errors->has('quan_huyen'))
                    <div style="color: red;">{{ $errors->first('quan_huyen') }}</div>
                    @endif
                </strong><br>
                <select class="form-select" name="quan_huyen" id="district2">
                    <option selected="">
                        -- Chọn Quận/Huyện --
                    </option>
                </select>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="notes" id="selfReason" placeholder="Lý do khám" rows="3"></textarea>
            </div>
            <div class="mb-3">
                <label class="form-label">
                    Hình thức thanh toán
