                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-between align-items-center">
                            @foreach($specialty->slice(0, 3) as $item)
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-between align-items-center">
                            @foreach($specialty->slice(3, 3) as $item)
                            <a href="{{ route('booKingCare', $item->id) }}" style="text-decoration: none;">
                                <div class="specialty-card">
                                    <img alt="Image of a joint representing {{$item->name}}" src="{{ asset('upload/' . $item->image) }}" />
                                    <p>{{$item->name}}</p>
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-between align-items-center">
                            @foreach($specialty->slice(6, 3) as $item)
                            <a href="{{ route('booKingCare', $item->id) }}" style="text-decoration: none;">
                                <div class="specialty-card">
                                    <img alt="Image of a joint representing {{$item->name}}" src="{{ asset('upload/' . $item->image) }}" />
                                    <p>{{$item->name}}</p>
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-between align-items-center">
                            @foreach($specialty->slice(9, 3) as $item)
                            <a href="{{ route('booKingCare', $item->id) }}" style="text-decoration: none;">
                                <div class="specialty-card">
                                    <img alt="Image of a joint representing {{$item->name}}" src="{{ asset('upload/' . $item->image) }}" />
                                    <p>{{$item->name}}</p>
        ...
        <div class="container mt-5">
            ...
            <div id="specialtyCarousel2" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-between align-items-center">
                            @foreach($specialtyktx->slice(0, 3) as $item)
                            <a href="{{ route('booKingCare', $item->id) }}" style="text-decoration: none;">
                                <div class="specialty-card">
                                    <img alt="Image of a joint representing {{$item->name}}" src="{{ asset('upload/' . $item->image) }}" />
                                    <p>{{$item->name}}</p>
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-between align-items-center">
                            @foreach($specialtyktx->slice(3, 3) as $item)
                            <a href="{{ route('booKingCare', $item->id) }}" style="text-decoration: none;">
                                <div class="specialty-card">
                                    <img alt="Image of a joint representing {{$item->name}}" src="{{ asset('upload/' . $item->image) }}" />
                                    <p>{{$item->name}}</p>
        ...
        <div class="container mt-5">
            ...
            <div id="specialtyCarousel3" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-between align-items-center">
                            @foreach($specialtytq->slice(0, 3) as $item)
                            <a href="{{ route('booKingCare', $item->id) }}" style="text-decoration: none;">
                                <div class="specialty-card">
                                    <img alt="Image of a joint representing {{$item->name}}" src="{{ asset('upload/' . $item->image) }}" />
                                    <p>{{$item->name}}</p>
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-between align-items-center">
                            @foreach($specialtytq->slice(3, 3) as $item)
                            <a href="{{ route('booKingCare', $item->id) }}" style="text-decoration: none;">
                                <div class="specialty-card">
                                    <img alt="Image of a joint representing {{$item->name}}" src="{{ asset('upload/' . $item->image) }}" />
                                    <p>{{$item->name}}</p>
        ...
        <div class="container mt-5">
            ...
            <div id="specialtyCarousel4" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-between align-items-center">
                            @foreach($specialtyxnyh->slice(0, 3) as $item)
                            <a href="{{ route('booKingCare', $item->id) }}" style="text-decoration: none;">
                                <div class="specialty-card">
                                    <img alt="Image of a joint representing {{$item->name}}" src="{{ asset('upload/' . $item->image) }}" />
                                    <p>{{$item->name}}</p>
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-between align-items-center">
                            @foreach($specialtyxnyh->slice(3, 3) as $item)
                            <a href="{{ route('booKingCare', $item->id) }}" style="text-decoration: none;">
                                <div class="specialty-card">
                                    <img alt="Image of a joint representing {{$item->name}}" src="{{ asset('upload/' . $item->image) }}" />
                                    <p>{{$item->name}}</p>
