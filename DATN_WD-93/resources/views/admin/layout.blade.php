                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseCate" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="{{ route('admin.categories.categoriesList') }}">List
                                    categories</a>
                                <a class="nav-link" href="{{ route('admin.categories.viewCateAdd') }}">Add
                                    categories</a>
                            </nav>
                        </div>
                        ...
                        <!-- brand -->
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                            data-bs-target="#collapseBrand" aria-expanded="false" aria-controls="collapseLayouts">
                            <div class="sb-nav-link-icon">
                                <i class="fas fa-columns"></i>
                            </div>
                            Brand
                        ...
                        <!-- comment -->
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                            data-bs-target="#collapseComment" aria-expanded="false" aria-controls="collapseLayouts">
                            <div class="sb-nav-link-icon">
                                <i class="fas fa-columns"></i>
                            </div>
                            Comment
